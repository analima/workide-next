...
export const CarolContainer = styled.div<IDica>`
  position: fixed;
  bottom: 0;
...
export const CarolIconClose = styled.div`
  display: flex;
  justify-content: flex-end;
  margin-right: 50px;
`;

export const CarolMensagem = styled.div`
  width: 280px;
  height: 230px;
  padding: 16px;
...
export const CarolPersonagem = styled.div`
  margin-left: 160px;
`;
