...
import { AZUL, CINZA_80, VERDE, VERMELHO } from '../../../../styles/variaveis';
  ...
  return (
    <Content>
      ...
      <Row className="mt-5">
        <Col lg={12}>
          <span>
            Em uma escala de 0 a 10, quais chances de você inficar a freelas
            town para um amigo?
          </span>
        </Col>
        <Col lg={12} className="d-flex">
          {range(0, 11).map(numero => (
            <LabelIndicacao
              key={numero}
              onClick={() => setNota_plataforma(numero)}
              checked={
      ...
      <Row className="mt-4">
        <Col lg={12}>
          <TextArea
            ...
            label="Deixe uma mensagem falando um pouco mais"
            contador={false}
          />
        </Col>
      </Row>
